        ...
        <div>
            ...
            <div className="flex mt-4 gap-x-2">
                ...
                <button
                    ...
                    type="button"
                    className="flex items-center justify-center w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-violet-600 hover:bg-slate-200">
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 32 32"
